...
/// An enum representing the possible values of an `Source`'s `allow_redisplay` field.
#[derive(Copy, Clone, Debug, Deserialize, Serialize, Eq, PartialEq)]
#[serde(rename_all = "snake_case")]
...
impl SourceAllowRedisplay {
    pub fn as_str(self) -> &'static str {
        match self {
            SourceAllowRedisplay::Always => "always",
            SourceAllowRedisplay::Limited => "limited",
            SourceAllowRedisplay::Unspecified => "unspecified",
        }
    }
}

impl AsRef<str> for SourceAllowRedisplay {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl std::default::Default for SourceAllowRedisplay {
    fn default() -> Self {
        Self::Always
    }
}
