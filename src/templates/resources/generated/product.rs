...
pub struct CreateProduct<'a> {
    ...
    /// These are displayed in [pricing tables](https://stripe.com/docs/payments/checkout/pricing-table).
    #[serde(skip_serializing_if = "Option::is_none")]
    pub marketing_features: Option<Vec<CreateProductMarketingFeatures>>,
...
impl<'a> CreateProduct<'a> {
    pub fn new(name: &'a str) -> Self {
        CreateProduct {
            ...
            marketing_features: Default::default(),
...
pub struct UpdateProduct<'a> {
    ...
    /// These are displayed in [pricing tables](https://stripe.com/docs/payments/checkout/pricing-table).
    #[serde(skip_serializing_if = "Option::is_none")]
    pub marketing_features: Option<Vec<UpdateProductMarketingFeatures>>,
...
pub struct CreateProductDefaultPriceData {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub custom_unit_amount: Option<CreateProductDefaultPriceDataCustomUnitAmount>,
...
#[derive(Clone, Debug, Default, Deserialize, Serialize)]
pub struct CreateProductMarketingFeatures {
...
#[derive(Clone, Debug, Default, Deserialize, Serialize)]
pub struct UpdateProductMarketingFeatures {
...
#[derive(Clone, Debug, Default, Deserialize, Serialize)]
pub struct CreateProductDefaultPriceDataCustomUnitAmount {
